...
## Green Edge Marine Optics

<center>AOP & IOP update</center>
...
- No major changes calling a v.02 of the release. But:
- Correction of few bugs and missing details,
- Addition of averaged profiles.

## AOP: Minor bugs correction
...
- GE2016-AMOW cruise: Three (somehow forgotten) profiles have been processed
    - GE2016.AMOW_COPS_160630_CAST_003
	  - GE2016.AMOW_COPS_160701_CAST_003
	  - GE2016.AMOW_COPS_160706_CAST_002

## AOP: Minor bugs correction

- Ge2016-ICMP cruise: Three (also forgotten!) profiles have been processed:
    - GE2016.ICMP_ICEP_160606_CAST_001
	  - GE2016.ICMP_ICEP_160606_CAST_002
	  - GE2016.ICMP_ICEP_160606_CAST_003
<br>

- Correction of few errors in the GE2016.AMIS-GE2016.AMOW log files (bad dates and station ID mainly).

## AOP: Addition of averaged profiles

- In addition of originally provided individual profiles, averaged profiles per station have been computed. For the 2015 ice camp data, "high snow" and "low snow" profiles have not been merged during the averaging.

## IOP: data release

- IOP data have just been released. The parameters include all the following, on a 0.25 m depth grid:
  - "a" (abs. coef.) and "c" (beam att. coef.) interpolated every 5 nm, from approx. 400 to 740 nm,
  - "bbp" (particle back scattering coef.) at 412, 440, 488, 510, 532, 595, 650, 676, 700, 715, 720, 770 and 870 nm,
  - temperature and salinity,
  - CDOM and Chl-a concentration.
  
* a LISST-Deep sensor was also used during GE, but corresponding data have not been processed yet...
* IOP data include ice camp data only. Amundsen based IOP data are processed by UQAR. 

## IOP: data release

- Idem AOP: details on data processing are given in a html doc., called "GE.Optics.IOP.report.html", which can be found on the GE DB. Basically, 2 main things to remember:
...
<center>
<img src="images/cdom.cleaning.png" height="600" /> 
</center>

## IOP: Data averaging

<center>
<img src="images/2016_iop_c.png" height="600" /> 
</center>
...
```{r, echo=FALSE, warning=FALSE, fig.align='center', fig.width=10, fig.height=6, dev='svg'}
